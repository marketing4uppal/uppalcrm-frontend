...
const DeleteAccountModal = ({ account, isOpen, onClose, onDelete }) => {
  ...
  const fetchDeleteInfo = async () => {
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/accounts/${account._id}/delete-info`, {
        headers: {
  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.post(`${import.meta.env.VITE_API_URL}/api/accounts/${account._id}/soft-delete`, {
        ...
        {loading ? (
          ...
          <div className="p-6">
            ...
            <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <h4 className="font-medium text-blue-800 mb-3">Account Summary</h4>
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium">{formatCurrency(account?.currentMonthlyPrice)}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Calendar className="w-4 h-4 text-blue-600" />
                  <span className="text-gray-600">Service:</span>
                  <span className="font-medium capitalize">{account?.serviceType}</span>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-red-700 mt-1">
                      This account has active relationships that prevent deletion:
                    </p>
                    ...
                    <div className="mt-3 p-3 bg-red-100 rounded-lg">
                      ...
                      <ul className="text-xs text-red-700 mt-1 space-y-1">
                        <li>• Close or delete associated deals first</li>
            ...
            {/* Only show deletion form if account can be deleted */}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      >
                        ...
                        <option value="Account Closed">Account Closed by Client</option>
                    ...
                    <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className={`font-medium px-2 py-1 rounded text-xs ${getStatusColor(account?.status)}`}>
                            {account?.status?.toUpperCase()}
                          </span>
                        </div>
                        <div className="flex justify-between">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-yellow-700 mt-1">
                            This action will soft-delete the account. You can restore it later if needed.
                          </p>
                        </div>
                      </div>
                    </div>
